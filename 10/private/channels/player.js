...
module.exports = function (m, session) {
	...
	function updatePlayer () {
		...
		if (player.password === false) {
			//console.log("not updating guest");
		} else {
			m.db.users.update({
	...
	function userHitsWolf (user, wolf, hit) {
	    ...
	    user.game.skills.melee.experience += Math.ceil(hit);
	    user.game.skills.life.experience += Math.ceil(hit*0.75);
	    wolf.skills.life.experience += Math.ceil(hit*0.75);
